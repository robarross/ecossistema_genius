# Contrato De Integracao - Mod_Gestao_Automacoes

## Objetivo

Definir como o modulo Mod_Gestao_Automacoes se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Automacoes.evento.criado
- Mod_Gestao_Automacoes.evento.atualizado
- Mod_Gestao_Automacoes.evento.status_alterado
- Mod_Gestao_Automacoes.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Automacoes/status
- GET /api/modulos/Mod_Gestao_Automacoes/submodulos
- GET /api/modulos/Mod_Gestao_Automacoes/registros
- POST /api/modulos/Mod_Gestao_Automacoes/entrada
- POST /api/modulos/Mod_Gestao_Automacoes/evento
- PATCH /api/modulos/Mod_Gestao_Automacoes/status
...
- Mod_Gestao_Automacoes.dashboard_operacional
- Mod_Gestao_Automacoes.dashboard_indicadores
- Mod_Gestao_Automacoes.dashboard_alertas
