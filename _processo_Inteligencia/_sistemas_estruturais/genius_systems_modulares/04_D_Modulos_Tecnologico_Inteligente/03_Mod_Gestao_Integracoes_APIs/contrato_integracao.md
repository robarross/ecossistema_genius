# Contrato De Integracao - Mod_Gestao_Integracoes_APIs

## Objetivo

Definir como o modulo Mod_Gestao_Integracoes_APIs se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Integracoes_APIs.evento.criado
- Mod_Gestao_Integracoes_APIs.evento.atualizado
- Mod_Gestao_Integracoes_APIs.evento.status_alterado
- Mod_Gestao_Integracoes_APIs.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Integracoes_APIs/status
- GET /api/modulos/Mod_Gestao_Integracoes_APIs/submodulos
- GET /api/modulos/Mod_Gestao_Integracoes_APIs/registros
- POST /api/modulos/Mod_Gestao_Integracoes_APIs/entrada
- POST /api/modulos/Mod_Gestao_Integracoes_APIs/evento
- PATCH /api/modulos/Mod_Gestao_Integracoes_APIs/status
...
- Mod_Gestao_Integracoes_APIs.dashboard_operacional
- Mod_Gestao_Integracoes_APIs.dashboard_indicadores
- Mod_Gestao_Integracoes_APIs.dashboard_alertas
