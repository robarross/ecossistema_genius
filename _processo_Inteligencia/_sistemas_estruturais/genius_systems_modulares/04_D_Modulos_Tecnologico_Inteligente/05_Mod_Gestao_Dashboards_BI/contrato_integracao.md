# Contrato De Integracao - Mod_Gestao_Dashboards_BI

## Objetivo

Definir como o modulo Mod_Gestao_Dashboards_BI se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Dashboards_BI.evento.criado
- Mod_Gestao_Dashboards_BI.evento.atualizado
- Mod_Gestao_Dashboards_BI.evento.status_alterado
- Mod_Gestao_Dashboards_BI.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Dashboards_BI/status
- GET /api/modulos/Mod_Gestao_Dashboards_BI/submodulos
- GET /api/modulos/Mod_Gestao_Dashboards_BI/registros
- POST /api/modulos/Mod_Gestao_Dashboards_BI/entrada
- POST /api/modulos/Mod_Gestao_Dashboards_BI/evento
- PATCH /api/modulos/Mod_Gestao_Dashboards_BI/status
...
- Mod_Gestao_Dashboards_BI.dashboard_operacional
- Mod_Gestao_Dashboards_BI.dashboard_indicadores
- Mod_Gestao_Dashboards_BI.dashboard_alertas
