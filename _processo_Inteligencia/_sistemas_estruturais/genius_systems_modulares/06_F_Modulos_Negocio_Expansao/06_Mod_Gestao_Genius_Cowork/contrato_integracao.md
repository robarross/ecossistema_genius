# Contrato De Integracao - Mod_Gestao_Genius_Cowork

## Objetivo

Definir como o modulo Mod_Gestao_Genius_Cowork se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Genius_Cowork.evento.criado
- Mod_Gestao_Genius_Cowork.evento.atualizado
- Mod_Gestao_Genius_Cowork.evento.status_alterado
- Mod_Gestao_Genius_Cowork.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Genius_Cowork/status
- GET /api/modulos/Mod_Gestao_Genius_Cowork/submodulos
- GET /api/modulos/Mod_Gestao_Genius_Cowork/registros
- POST /api/modulos/Mod_Gestao_Genius_Cowork/entrada
- POST /api/modulos/Mod_Gestao_Genius_Cowork/evento
- PATCH /api/modulos/Mod_Gestao_Genius_Cowork/status
...
- Mod_Gestao_Genius_Cowork.dashboard_operacional
- Mod_Gestao_Genius_Cowork.dashboard_indicadores
- Mod_Gestao_Genius_Cowork.dashboard_alertas
