# Contrato De Integracao - Mod_Gestao_Comunidade_Agricola

## Objetivo

Definir como o modulo Mod_Gestao_Comunidade_Agricola se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Comunidade_Agricola.evento.criado
- Mod_Gestao_Comunidade_Agricola.evento.atualizado
- Mod_Gestao_Comunidade_Agricola.evento.status_alterado
- Mod_Gestao_Comunidade_Agricola.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Comunidade_Agricola/status
- GET /api/modulos/Mod_Gestao_Comunidade_Agricola/submodulos
- GET /api/modulos/Mod_Gestao_Comunidade_Agricola/registros
- POST /api/modulos/Mod_Gestao_Comunidade_Agricola/entrada
- POST /api/modulos/Mod_Gestao_Comunidade_Agricola/evento
- PATCH /api/modulos/Mod_Gestao_Comunidade_Agricola/status
...
- Mod_Gestao_Comunidade_Agricola.dashboard_operacional
- Mod_Gestao_Comunidade_Agricola.dashboard_indicadores
- Mod_Gestao_Comunidade_Agricola.dashboard_alertas
