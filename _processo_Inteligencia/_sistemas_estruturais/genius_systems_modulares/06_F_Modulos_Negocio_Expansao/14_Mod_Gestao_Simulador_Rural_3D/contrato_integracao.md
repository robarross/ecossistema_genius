# Contrato De Integracao - Mod_Gestao_Simulador_Rural_3D

## Objetivo

Definir como o modulo Mod_Gestao_Simulador_Rural_3D se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Simulador_Rural_3D.evento.criado
- Mod_Gestao_Simulador_Rural_3D.evento.atualizado
- Mod_Gestao_Simulador_Rural_3D.evento.status_alterado
- Mod_Gestao_Simulador_Rural_3D.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Simulador_Rural_3D/status
- GET /api/modulos/Mod_Gestao_Simulador_Rural_3D/submodulos
- GET /api/modulos/Mod_Gestao_Simulador_Rural_3D/registros
- POST /api/modulos/Mod_Gestao_Simulador_Rural_3D/entrada
- POST /api/modulos/Mod_Gestao_Simulador_Rural_3D/evento
- PATCH /api/modulos/Mod_Gestao_Simulador_Rural_3D/status
...
- Mod_Gestao_Simulador_Rural_3D.dashboard_operacional
- Mod_Gestao_Simulador_Rural_3D.dashboard_indicadores
- Mod_Gestao_Simulador_Rural_3D.dashboard_alertas
