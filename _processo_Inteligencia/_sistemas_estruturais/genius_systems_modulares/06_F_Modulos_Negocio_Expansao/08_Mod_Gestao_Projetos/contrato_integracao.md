# Contrato De Integracao - Mod_Gestao_Projetos

## Objetivo

Definir como o modulo Mod_Gestao_Projetos se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Projetos.evento.criado
- Mod_Gestao_Projetos.evento.atualizado
- Mod_Gestao_Projetos.evento.status_alterado
- Mod_Gestao_Projetos.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Projetos/status
- GET /api/modulos/Mod_Gestao_Projetos/submodulos
- GET /api/modulos/Mod_Gestao_Projetos/registros
- POST /api/modulos/Mod_Gestao_Projetos/entrada
- POST /api/modulos/Mod_Gestao_Projetos/evento
- PATCH /api/modulos/Mod_Gestao_Projetos/status
...
- Mod_Gestao_Projetos.dashboard_operacional
- Mod_Gestao_Projetos.dashboard_indicadores
- Mod_Gestao_Projetos.dashboard_alertas
