# Contrato De Integracao - Mod_Gestao_Regularizacao_Fundiaria

## Objetivo

Definir como o modulo Mod_Gestao_Regularizacao_Fundiaria se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Regularizacao_Fundiaria.evento.criado
- Mod_Gestao_Regularizacao_Fundiaria.evento.atualizado
- Mod_Gestao_Regularizacao_Fundiaria.evento.status_alterado
- Mod_Gestao_Regularizacao_Fundiaria.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Regularizacao_Fundiaria/status
- GET /api/modulos/Mod_Gestao_Regularizacao_Fundiaria/submodulos
- GET /api/modulos/Mod_Gestao_Regularizacao_Fundiaria/registros
- POST /api/modulos/Mod_Gestao_Regularizacao_Fundiaria/entrada
- POST /api/modulos/Mod_Gestao_Regularizacao_Fundiaria/evento
- PATCH /api/modulos/Mod_Gestao_Regularizacao_Fundiaria/status
...
- Mod_Gestao_Regularizacao_Fundiaria.dashboard_operacional
- Mod_Gestao_Regularizacao_Fundiaria.dashboard_indicadores
- Mod_Gestao_Regularizacao_Fundiaria.dashboard_alertas
