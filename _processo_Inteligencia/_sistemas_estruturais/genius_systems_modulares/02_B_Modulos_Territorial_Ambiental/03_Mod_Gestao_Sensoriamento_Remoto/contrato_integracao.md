# Contrato De Integracao - Mod_Gestao_Sensoriamento_Remoto

## Objetivo

Definir como o modulo Mod_Gestao_Sensoriamento_Remoto se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Sensoriamento_Remoto.evento.criado
- Mod_Gestao_Sensoriamento_Remoto.evento.atualizado
- Mod_Gestao_Sensoriamento_Remoto.evento.status_alterado
- Mod_Gestao_Sensoriamento_Remoto.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Sensoriamento_Remoto/status
- GET /api/modulos/Mod_Gestao_Sensoriamento_Remoto/submodulos
- GET /api/modulos/Mod_Gestao_Sensoriamento_Remoto/registros
- POST /api/modulos/Mod_Gestao_Sensoriamento_Remoto/entrada
- POST /api/modulos/Mod_Gestao_Sensoriamento_Remoto/evento
- PATCH /api/modulos/Mod_Gestao_Sensoriamento_Remoto/status
...
- Mod_Gestao_Sensoriamento_Remoto.dashboard_operacional
- Mod_Gestao_Sensoriamento_Remoto.dashboard_indicadores
- Mod_Gestao_Sensoriamento_Remoto.dashboard_alertas
