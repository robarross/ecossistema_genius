# Contrato De Integracao - Mod_Gestao_Producao_Animal_Pecuaria

## Objetivo

Definir como o modulo Mod_Gestao_Producao_Animal_Pecuaria se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Producao_Animal_Pecuaria.evento.criado
- Mod_Gestao_Producao_Animal_Pecuaria.evento.atualizado
- Mod_Gestao_Producao_Animal_Pecuaria.evento.status_alterado
- Mod_Gestao_Producao_Animal_Pecuaria.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Producao_Animal_Pecuaria/status
- GET /api/modulos/Mod_Gestao_Producao_Animal_Pecuaria/submodulos
- GET /api/modulos/Mod_Gestao_Producao_Animal_Pecuaria/registros
- POST /api/modulos/Mod_Gestao_Producao_Animal_Pecuaria/entrada
- POST /api/modulos/Mod_Gestao_Producao_Animal_Pecuaria/evento
- PATCH /api/modulos/Mod_Gestao_Producao_Animal_Pecuaria/status
...
- Mod_Gestao_Producao_Animal_Pecuaria.dashboard_operacional
- Mod_Gestao_Producao_Animal_Pecuaria.dashboard_indicadores
- Mod_Gestao_Producao_Animal_Pecuaria.dashboard_alertas
