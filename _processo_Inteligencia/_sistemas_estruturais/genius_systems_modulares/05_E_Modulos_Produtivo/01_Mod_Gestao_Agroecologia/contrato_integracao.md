# Contrato De Integracao - Mod_Gestao_Agroecologia

## Objetivo

Definir como o modulo Mod_Gestao_Agroecologia se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Agroecologia.evento.criado
- Mod_Gestao_Agroecologia.evento.atualizado
- Mod_Gestao_Agroecologia.evento.status_alterado
- Mod_Gestao_Agroecologia.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Agroecologia/status
- GET /api/modulos/Mod_Gestao_Agroecologia/submodulos
- GET /api/modulos/Mod_Gestao_Agroecologia/registros
- POST /api/modulos/Mod_Gestao_Agroecologia/entrada
- POST /api/modulos/Mod_Gestao_Agroecologia/evento
- PATCH /api/modulos/Mod_Gestao_Agroecologia/status
...
- Mod_Gestao_Agroecologia.dashboard_operacional
- Mod_Gestao_Agroecologia.dashboard_indicadores
- Mod_Gestao_Agroecologia.dashboard_alertas
