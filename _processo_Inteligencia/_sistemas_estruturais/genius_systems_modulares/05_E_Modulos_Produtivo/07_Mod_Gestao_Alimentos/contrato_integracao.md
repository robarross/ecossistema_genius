# Contrato De Integracao - Mod_Gestao_Alimentos

## Objetivo

Definir como o modulo Mod_Gestao_Alimentos se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Alimentos.evento.criado
- Mod_Gestao_Alimentos.evento.atualizado
- Mod_Gestao_Alimentos.evento.status_alterado
- Mod_Gestao_Alimentos.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Alimentos/status
- GET /api/modulos/Mod_Gestao_Alimentos/submodulos
- GET /api/modulos/Mod_Gestao_Alimentos/registros
- POST /api/modulos/Mod_Gestao_Alimentos/entrada
- POST /api/modulos/Mod_Gestao_Alimentos/evento
- PATCH /api/modulos/Mod_Gestao_Alimentos/status
...
- Mod_Gestao_Alimentos.dashboard_operacional
- Mod_Gestao_Alimentos.dashboard_indicadores
- Mod_Gestao_Alimentos.dashboard_alertas
