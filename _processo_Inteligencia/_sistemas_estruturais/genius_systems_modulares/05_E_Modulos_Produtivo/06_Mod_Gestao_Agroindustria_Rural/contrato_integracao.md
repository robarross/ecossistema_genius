# Contrato De Integracao - Mod_Gestao_Agroindustria_Rural

## Objetivo

Definir como o modulo Mod_Gestao_Agroindustria_Rural se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Agroindustria_Rural.evento.criado
- Mod_Gestao_Agroindustria_Rural.evento.atualizado
- Mod_Gestao_Agroindustria_Rural.evento.status_alterado
- Mod_Gestao_Agroindustria_Rural.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Agroindustria_Rural/status
- GET /api/modulos/Mod_Gestao_Agroindustria_Rural/submodulos
- GET /api/modulos/Mod_Gestao_Agroindustria_Rural/registros
- POST /api/modulos/Mod_Gestao_Agroindustria_Rural/entrada
- POST /api/modulos/Mod_Gestao_Agroindustria_Rural/evento
- PATCH /api/modulos/Mod_Gestao_Agroindustria_Rural/status
...
- Mod_Gestao_Agroindustria_Rural.dashboard_operacional
- Mod_Gestao_Agroindustria_Rural.dashboard_indicadores
- Mod_Gestao_Agroindustria_Rural.dashboard_alertas
