# Contrato De Integracao - Mod_Gestao_Florestal

## Objetivo

Definir como o modulo Mod_Gestao_Florestal se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Florestal.evento.criado
- Mod_Gestao_Florestal.evento.atualizado
- Mod_Gestao_Florestal.evento.status_alterado
- Mod_Gestao_Florestal.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Florestal/status
- GET /api/modulos/Mod_Gestao_Florestal/submodulos
- GET /api/modulos/Mod_Gestao_Florestal/registros
- POST /api/modulos/Mod_Gestao_Florestal/entrada
- POST /api/modulos/Mod_Gestao_Florestal/evento
- PATCH /api/modulos/Mod_Gestao_Florestal/status
...
- Mod_Gestao_Florestal.dashboard_operacional
- Mod_Gestao_Florestal.dashboard_indicadores
- Mod_Gestao_Florestal.dashboard_alertas
