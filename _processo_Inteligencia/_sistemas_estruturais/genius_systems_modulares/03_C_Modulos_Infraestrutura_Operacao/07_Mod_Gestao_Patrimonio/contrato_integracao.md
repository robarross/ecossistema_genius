# Contrato De Integracao - Mod_Gestao_Patrimonio

## Objetivo

Definir como o modulo Mod_Gestao_Patrimonio se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Patrimonio.evento.criado
- Mod_Gestao_Patrimonio.evento.atualizado
- Mod_Gestao_Patrimonio.evento.status_alterado
- Mod_Gestao_Patrimonio.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Patrimonio/status
- GET /api/modulos/Mod_Gestao_Patrimonio/submodulos
- GET /api/modulos/Mod_Gestao_Patrimonio/registros
- POST /api/modulos/Mod_Gestao_Patrimonio/entrada
- POST /api/modulos/Mod_Gestao_Patrimonio/evento
- PATCH /api/modulos/Mod_Gestao_Patrimonio/status
...
- Mod_Gestao_Patrimonio.dashboard_operacional
- Mod_Gestao_Patrimonio.dashboard_indicadores
- Mod_Gestao_Patrimonio.dashboard_alertas
