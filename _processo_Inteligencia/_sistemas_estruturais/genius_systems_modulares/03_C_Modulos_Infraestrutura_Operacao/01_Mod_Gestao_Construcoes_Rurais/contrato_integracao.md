# Contrato De Integracao - Mod_Gestao_Construcoes_Rurais

## Objetivo

Definir como o modulo Mod_Gestao_Construcoes_Rurais se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Construcoes_Rurais.evento.criado
- Mod_Gestao_Construcoes_Rurais.evento.atualizado
- Mod_Gestao_Construcoes_Rurais.evento.status_alterado
- Mod_Gestao_Construcoes_Rurais.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Construcoes_Rurais/status
- GET /api/modulos/Mod_Gestao_Construcoes_Rurais/submodulos
- GET /api/modulos/Mod_Gestao_Construcoes_Rurais/registros
- POST /api/modulos/Mod_Gestao_Construcoes_Rurais/entrada
- POST /api/modulos/Mod_Gestao_Construcoes_Rurais/evento
- PATCH /api/modulos/Mod_Gestao_Construcoes_Rurais/status
...
- Mod_Gestao_Construcoes_Rurais.dashboard_operacional
- Mod_Gestao_Construcoes_Rurais.dashboard_indicadores
- Mod_Gestao_Construcoes_Rurais.dashboard_alertas
