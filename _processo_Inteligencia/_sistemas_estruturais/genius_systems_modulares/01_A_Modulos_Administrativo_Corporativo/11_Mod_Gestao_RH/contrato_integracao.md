# Contrato De Integracao - Mod_Gestao_RH

## Objetivo

Definir como o modulo Mod_Gestao_RH se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_RH.evento.criado
- Mod_Gestao_RH.evento.atualizado
- Mod_Gestao_RH.evento.status_alterado
- Mod_Gestao_RH.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_RH/status
- GET /api/modulos/Mod_Gestao_RH/submodulos
- GET /api/modulos/Mod_Gestao_RH/registros
- POST /api/modulos/Mod_Gestao_RH/entrada
- POST /api/modulos/Mod_Gestao_RH/evento
- PATCH /api/modulos/Mod_Gestao_RH/status
...
- Mod_Gestao_RH.dashboard_operacional
- Mod_Gestao_RH.dashboard_indicadores
- Mod_Gestao_RH.dashboard_alertas
