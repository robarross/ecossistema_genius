# Contrato De Integracao - Mod_Gestao_Comercial

## Objetivo

Definir como o modulo Mod_Gestao_Comercial se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Comercial.evento.criado
- Mod_Gestao_Comercial.evento.atualizado
- Mod_Gestao_Comercial.evento.status_alterado
- Mod_Gestao_Comercial.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Comercial/status
- GET /api/modulos/Mod_Gestao_Comercial/submodulos
- GET /api/modulos/Mod_Gestao_Comercial/registros
- POST /api/modulos/Mod_Gestao_Comercial/entrada
- POST /api/modulos/Mod_Gestao_Comercial/evento
- PATCH /api/modulos/Mod_Gestao_Comercial/status
...
- Mod_Gestao_Comercial.dashboard_operacional
- Mod_Gestao_Comercial.dashboard_indicadores
- Mod_Gestao_Comercial.dashboard_alertas
