# Contrato De Integracao - Mod_Gestao_Contratos

## Objetivo

Definir como o modulo Mod_Gestao_Contratos se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Contratos.evento.criado
- Mod_Gestao_Contratos.evento.atualizado
- Mod_Gestao_Contratos.evento.status_alterado
- Mod_Gestao_Contratos.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Contratos/status
- GET /api/modulos/Mod_Gestao_Contratos/submodulos
- GET /api/modulos/Mod_Gestao_Contratos/registros
- POST /api/modulos/Mod_Gestao_Contratos/entrada
- POST /api/modulos/Mod_Gestao_Contratos/evento
- PATCH /api/modulos/Mod_Gestao_Contratos/status
...
- Mod_Gestao_Contratos.dashboard_operacional
- Mod_Gestao_Contratos.dashboard_indicadores
- Mod_Gestao_Contratos.dashboard_alertas
