# Contrato De Integracao - Mod_Gestao_Genius_In

## Objetivo

Definir como o modulo Mod_Gestao_Genius_In se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Genius_In.evento.criado
- Mod_Gestao_Genius_In.evento.atualizado
- Mod_Gestao_Genius_In.evento.status_alterado
- Mod_Gestao_Genius_In.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Genius_In/status
- GET /api/modulos/Mod_Gestao_Genius_In/submodulos
- GET /api/modulos/Mod_Gestao_Genius_In/registros
- POST /api/modulos/Mod_Gestao_Genius_In/entrada
- POST /api/modulos/Mod_Gestao_Genius_In/evento
- PATCH /api/modulos/Mod_Gestao_Genius_In/status
...
- Mod_Gestao_Genius_In.dashboard_operacional
- Mod_Gestao_Genius_In.dashboard_indicadores
- Mod_Gestao_Genius_In.dashboard_alertas
