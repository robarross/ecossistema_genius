# Contrato De Integracao - Mod_Gestao_Seguranca_Informacao

## Objetivo

Definir como o modulo Mod_Gestao_Seguranca_Informacao se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Seguranca_Informacao.evento.criado
- Mod_Gestao_Seguranca_Informacao.evento.atualizado
- Mod_Gestao_Seguranca_Informacao.evento.status_alterado
- Mod_Gestao_Seguranca_Informacao.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Seguranca_Informacao/status
- GET /api/modulos/Mod_Gestao_Seguranca_Informacao/submodulos
- GET /api/modulos/Mod_Gestao_Seguranca_Informacao/registros
- POST /api/modulos/Mod_Gestao_Seguranca_Informacao/entrada
- POST /api/modulos/Mod_Gestao_Seguranca_Informacao/evento
- PATCH /api/modulos/Mod_Gestao_Seguranca_Informacao/status
...
- Mod_Gestao_Seguranca_Informacao.dashboard_operacional
- Mod_Gestao_Seguranca_Informacao.dashboard_indicadores
- Mod_Gestao_Seguranca_Informacao.dashboard_alertas
