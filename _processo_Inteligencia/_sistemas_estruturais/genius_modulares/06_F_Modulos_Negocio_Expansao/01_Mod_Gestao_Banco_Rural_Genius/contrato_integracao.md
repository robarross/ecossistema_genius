# Contrato De Integracao - Mod_Gestao_Banco_Rural_Genius

## Objetivo

Definir como o modulo Mod_Gestao_Banco_Rural_Genius se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Banco_Rural_Genius.evento.criado
- Mod_Gestao_Banco_Rural_Genius.evento.atualizado
- Mod_Gestao_Banco_Rural_Genius.evento.status_alterado
- Mod_Gestao_Banco_Rural_Genius.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Banco_Rural_Genius/status
- GET /api/modulos/Mod_Gestao_Banco_Rural_Genius/submodulos
- GET /api/modulos/Mod_Gestao_Banco_Rural_Genius/registros
- POST /api/modulos/Mod_Gestao_Banco_Rural_Genius/entrada
- POST /api/modulos/Mod_Gestao_Banco_Rural_Genius/evento
- PATCH /api/modulos/Mod_Gestao_Banco_Rural_Genius/status
...
- Mod_Gestao_Banco_Rural_Genius.dashboard_operacional
- Mod_Gestao_Banco_Rural_Genius.dashboard_indicadores
- Mod_Gestao_Banco_Rural_Genius.dashboard_alertas
