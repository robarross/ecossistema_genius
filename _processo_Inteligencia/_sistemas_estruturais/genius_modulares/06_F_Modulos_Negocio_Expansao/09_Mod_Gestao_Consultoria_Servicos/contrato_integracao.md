# Contrato De Integracao - Mod_Gestao_Consultoria_Servicos

## Objetivo

Definir como o modulo Mod_Gestao_Consultoria_Servicos se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Consultoria_Servicos.evento.criado
- Mod_Gestao_Consultoria_Servicos.evento.atualizado
- Mod_Gestao_Consultoria_Servicos.evento.status_alterado
- Mod_Gestao_Consultoria_Servicos.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Consultoria_Servicos/status
- GET /api/modulos/Mod_Gestao_Consultoria_Servicos/submodulos
- GET /api/modulos/Mod_Gestao_Consultoria_Servicos/registros
- POST /api/modulos/Mod_Gestao_Consultoria_Servicos/entrada
- POST /api/modulos/Mod_Gestao_Consultoria_Servicos/evento
- PATCH /api/modulos/Mod_Gestao_Consultoria_Servicos/status
...
- Mod_Gestao_Consultoria_Servicos.dashboard_operacional
- Mod_Gestao_Consultoria_Servicos.dashboard_indicadores
- Mod_Gestao_Consultoria_Servicos.dashboard_alertas
