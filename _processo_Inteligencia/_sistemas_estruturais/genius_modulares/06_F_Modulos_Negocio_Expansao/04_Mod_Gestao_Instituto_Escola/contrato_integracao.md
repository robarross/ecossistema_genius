# Contrato De Integracao - Mod_Gestao_Instituto_Escola

## Objetivo

Definir como o modulo Mod_Gestao_Instituto_Escola se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Instituto_Escola.evento.criado
- Mod_Gestao_Instituto_Escola.evento.atualizado
- Mod_Gestao_Instituto_Escola.evento.status_alterado
- Mod_Gestao_Instituto_Escola.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Instituto_Escola/status
- GET /api/modulos/Mod_Gestao_Instituto_Escola/submodulos
- GET /api/modulos/Mod_Gestao_Instituto_Escola/registros
- POST /api/modulos/Mod_Gestao_Instituto_Escola/entrada
- POST /api/modulos/Mod_Gestao_Instituto_Escola/evento
- PATCH /api/modulos/Mod_Gestao_Instituto_Escola/status
...
- Mod_Gestao_Instituto_Escola.dashboard_operacional
- Mod_Gestao_Instituto_Escola.dashboard_indicadores
- Mod_Gestao_Instituto_Escola.dashboard_alertas
