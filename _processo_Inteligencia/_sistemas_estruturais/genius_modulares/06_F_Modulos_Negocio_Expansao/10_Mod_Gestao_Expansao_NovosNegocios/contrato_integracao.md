# Contrato De Integracao - Mod_Gestao_Expansao_NovosNegocios

## Objetivo

Definir como o modulo Mod_Gestao_Expansao_NovosNegocios se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Plataforma: 07_Plataforma_Genius_Mercado_Rural

## Eventos Publicados

- Mod_Gestao_Expansao_NovosNegocios.evento.criado
- Mod_Gestao_Expansao_NovosNegocios.evento.atualizado
- Mod_Gestao_Expansao_NovosNegocios.evento.status_alterado
- Mod_Gestao_Expansao_NovosNegocios.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Expansao_NovosNegocios/status
- GET /api/modulos/Mod_Gestao_Expansao_NovosNegocios/submodulos
- GET /api/modulos/Mod_Gestao_Expansao_NovosNegocios/registros
- POST /api/modulos/Mod_Gestao_Expansao_NovosNegocios/entrada
- POST /api/modulos/Mod_Gestao_Expansao_NovosNegocios/evento
- PATCH /api/modulos/Mod_Gestao_Expansao_NovosNegocios/status
...
- Mod_Gestao_Expansao_NovosNegocios.dashboard_operacional
- Mod_Gestao_Expansao_NovosNegocios.dashboard_indicadores
- Mod_Gestao_Expansao_NovosNegocios.dashboard_alertas
