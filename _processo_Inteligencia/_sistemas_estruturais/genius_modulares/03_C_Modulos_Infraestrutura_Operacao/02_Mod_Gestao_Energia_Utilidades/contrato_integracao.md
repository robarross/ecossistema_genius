# Contrato De Integracao - Mod_Gestao_Energia_Utilidades

## Objetivo

Definir como o modulo Mod_Gestao_Energia_Utilidades se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Energia_Utilidades.evento.criado
- Mod_Gestao_Energia_Utilidades.evento.atualizado
- Mod_Gestao_Energia_Utilidades.evento.status_alterado
- Mod_Gestao_Energia_Utilidades.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Energia_Utilidades/status
- GET /api/modulos/Mod_Gestao_Energia_Utilidades/submodulos
- GET /api/modulos/Mod_Gestao_Energia_Utilidades/registros
- POST /api/modulos/Mod_Gestao_Energia_Utilidades/entrada
- POST /api/modulos/Mod_Gestao_Energia_Utilidades/evento
- PATCH /api/modulos/Mod_Gestao_Energia_Utilidades/status
...
- Mod_Gestao_Energia_Utilidades.dashboard_operacional
- Mod_Gestao_Energia_Utilidades.dashboard_indicadores
- Mod_Gestao_Energia_Utilidades.dashboard_alertas
