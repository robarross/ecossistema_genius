# Contrato De Integracao - Mod_Gestao_Irrigacao_Drenagem

## Objetivo

Definir como o modulo Mod_Gestao_Irrigacao_Drenagem se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Irrigacao_Drenagem.evento.criado
- Mod_Gestao_Irrigacao_Drenagem.evento.atualizado
- Mod_Gestao_Irrigacao_Drenagem.evento.status_alterado
- Mod_Gestao_Irrigacao_Drenagem.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Irrigacao_Drenagem/status
- GET /api/modulos/Mod_Gestao_Irrigacao_Drenagem/submodulos
- GET /api/modulos/Mod_Gestao_Irrigacao_Drenagem/registros
- POST /api/modulos/Mod_Gestao_Irrigacao_Drenagem/entrada
- POST /api/modulos/Mod_Gestao_Irrigacao_Drenagem/evento
- PATCH /api/modulos/Mod_Gestao_Irrigacao_Drenagem/status
...
- Mod_Gestao_Irrigacao_Drenagem.dashboard_operacional
- Mod_Gestao_Irrigacao_Drenagem.dashboard_indicadores
- Mod_Gestao_Irrigacao_Drenagem.dashboard_alertas
