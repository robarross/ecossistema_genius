# Contrato De Integracao - Mod_Gestao_Logistica

## Objetivo

Definir como o modulo Mod_Gestao_Logistica se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Logistica.evento.criado
- Mod_Gestao_Logistica.evento.atualizado
- Mod_Gestao_Logistica.evento.status_alterado
- Mod_Gestao_Logistica.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Logistica/status
- GET /api/modulos/Mod_Gestao_Logistica/submodulos
- GET /api/modulos/Mod_Gestao_Logistica/registros
- POST /api/modulos/Mod_Gestao_Logistica/entrada
- POST /api/modulos/Mod_Gestao_Logistica/evento
- PATCH /api/modulos/Mod_Gestao_Logistica/status
...
- Mod_Gestao_Logistica.dashboard_operacional
- Mod_Gestao_Logistica.dashboard_indicadores
- Mod_Gestao_Logistica.dashboard_alertas
