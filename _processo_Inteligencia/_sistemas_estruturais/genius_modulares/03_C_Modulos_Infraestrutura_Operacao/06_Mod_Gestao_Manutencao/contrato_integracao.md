# Contrato De Integracao - Mod_Gestao_Manutencao

## Objetivo

Definir como o modulo Mod_Gestao_Manutencao se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Manutencao.evento.criado
- Mod_Gestao_Manutencao.evento.atualizado
- Mod_Gestao_Manutencao.evento.status_alterado
- Mod_Gestao_Manutencao.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Manutencao/status
- GET /api/modulos/Mod_Gestao_Manutencao/submodulos
- GET /api/modulos/Mod_Gestao_Manutencao/registros
- POST /api/modulos/Mod_Gestao_Manutencao/entrada
- POST /api/modulos/Mod_Gestao_Manutencao/evento
- PATCH /api/modulos/Mod_Gestao_Manutencao/status
...
- Mod_Gestao_Manutencao.dashboard_operacional
- Mod_Gestao_Manutencao.dashboard_indicadores
- Mod_Gestao_Manutencao.dashboard_alertas
