# Contrato De Integracao - Mod_Gestao_Recursos_Hidricos

## Objetivo

Definir como o modulo Mod_Gestao_Recursos_Hidricos se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Recursos_Hidricos.evento.criado
- Mod_Gestao_Recursos_Hidricos.evento.atualizado
- Mod_Gestao_Recursos_Hidricos.evento.status_alterado
- Mod_Gestao_Recursos_Hidricos.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Recursos_Hidricos/status
- GET /api/modulos/Mod_Gestao_Recursos_Hidricos/submodulos
- GET /api/modulos/Mod_Gestao_Recursos_Hidricos/registros
- POST /api/modulos/Mod_Gestao_Recursos_Hidricos/entrada
- POST /api/modulos/Mod_Gestao_Recursos_Hidricos/evento
- PATCH /api/modulos/Mod_Gestao_Recursos_Hidricos/status
...
- Mod_Gestao_Recursos_Hidricos.dashboard_operacional
- Mod_Gestao_Recursos_Hidricos.dashboard_indicadores
- Mod_Gestao_Recursos_Hidricos.dashboard_alertas
