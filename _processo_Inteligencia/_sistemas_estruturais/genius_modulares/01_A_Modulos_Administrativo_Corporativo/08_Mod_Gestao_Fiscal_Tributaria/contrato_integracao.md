# Contrato De Integracao - Mod_Gestao_Fiscal_Tributaria

## Objetivo

Definir como o modulo Mod_Gestao_Fiscal_Tributaria se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Fiscal_Tributaria.evento.criado
- Mod_Gestao_Fiscal_Tributaria.evento.atualizado
- Mod_Gestao_Fiscal_Tributaria.evento.status_alterado
- Mod_Gestao_Fiscal_Tributaria.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Fiscal_Tributaria/status
- GET /api/modulos/Mod_Gestao_Fiscal_Tributaria/submodulos
- GET /api/modulos/Mod_Gestao_Fiscal_Tributaria/registros
- POST /api/modulos/Mod_Gestao_Fiscal_Tributaria/entrada
- POST /api/modulos/Mod_Gestao_Fiscal_Tributaria/evento
- PATCH /api/modulos/Mod_Gestao_Fiscal_Tributaria/status
...
- Mod_Gestao_Fiscal_Tributaria.dashboard_operacional
- Mod_Gestao_Fiscal_Tributaria.dashboard_indicadores
- Mod_Gestao_Fiscal_Tributaria.dashboard_alertas
