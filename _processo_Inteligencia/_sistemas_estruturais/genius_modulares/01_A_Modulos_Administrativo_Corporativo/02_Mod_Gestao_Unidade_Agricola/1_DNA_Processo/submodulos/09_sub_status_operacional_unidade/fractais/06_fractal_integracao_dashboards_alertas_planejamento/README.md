# 06_fractal_integracao_dashboards_alertas_planejamento

## Nome
Integracao dashboards alertas planejamento

## Funcao
Publica status para dashboards, alertas, planejamento, tarefas e agentes.
