# Contrato De Integracao - Mod_Gestao_Compras_Suprimentos

## Objetivo

Definir como o modulo Mod_Gestao_Compras_Suprimentos se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Compras_Suprimentos.evento.criado
- Mod_Gestao_Compras_Suprimentos.evento.atualizado
- Mod_Gestao_Compras_Suprimentos.evento.status_alterado
- Mod_Gestao_Compras_Suprimentos.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Compras_Suprimentos/status
- GET /api/modulos/Mod_Gestao_Compras_Suprimentos/submodulos
- GET /api/modulos/Mod_Gestao_Compras_Suprimentos/registros
- POST /api/modulos/Mod_Gestao_Compras_Suprimentos/entrada
- POST /api/modulos/Mod_Gestao_Compras_Suprimentos/evento
- PATCH /api/modulos/Mod_Gestao_Compras_Suprimentos/status
...
- Mod_Gestao_Compras_Suprimentos.dashboard_operacional
- Mod_Gestao_Compras_Suprimentos.dashboard_indicadores
- Mod_Gestao_Compras_Suprimentos.dashboard_alertas
