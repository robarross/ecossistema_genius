# Contrato De Integracao - Mod_Gestao_Governanca

## Objetivo

Definir como o modulo Mod_Gestao_Governanca se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Governanca.evento.criado
- Mod_Gestao_Governanca.evento.atualizado
- Mod_Gestao_Governanca.evento.status_alterado
- Mod_Gestao_Governanca.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Governanca/status
- GET /api/modulos/Mod_Gestao_Governanca/submodulos
- GET /api/modulos/Mod_Gestao_Governanca/registros
- POST /api/modulos/Mod_Gestao_Governanca/entrada
- POST /api/modulos/Mod_Gestao_Governanca/evento
- PATCH /api/modulos/Mod_Gestao_Governanca/status
...
- Mod_Gestao_Governanca.dashboard_operacional
- Mod_Gestao_Governanca.dashboard_indicadores
- Mod_Gestao_Governanca.dashboard_alertas
