# Contrato De Integracao - Mod_Gestao_Juridica

## Objetivo

Definir como o modulo Mod_Gestao_Juridica se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Juridica.evento.criado
- Mod_Gestao_Juridica.evento.atualizado
- Mod_Gestao_Juridica.evento.status_alterado
- Mod_Gestao_Juridica.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Juridica/status
- GET /api/modulos/Mod_Gestao_Juridica/submodulos
- GET /api/modulos/Mod_Gestao_Juridica/registros
- POST /api/modulos/Mod_Gestao_Juridica/entrada
- POST /api/modulos/Mod_Gestao_Juridica/evento
- PATCH /api/modulos/Mod_Gestao_Juridica/status
...
- Mod_Gestao_Juridica.dashboard_operacional
- Mod_Gestao_Juridica.dashboard_indicadores
- Mod_Gestao_Juridica.dashboard_alertas
