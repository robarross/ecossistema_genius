# Contrato De Integracao - Mod_Gestao_Financeira

## Objetivo

Definir como o modulo Mod_Gestao_Financeira se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Financeira.evento.criado
- Mod_Gestao_Financeira.evento.atualizado
- Mod_Gestao_Financeira.evento.status_alterado
- Mod_Gestao_Financeira.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Financeira/status
- GET /api/modulos/Mod_Gestao_Financeira/submodulos
- GET /api/modulos/Mod_Gestao_Financeira/registros
- POST /api/modulos/Mod_Gestao_Financeira/entrada
- POST /api/modulos/Mod_Gestao_Financeira/evento
- PATCH /api/modulos/Mod_Gestao_Financeira/status
...
- Mod_Gestao_Financeira.dashboard_operacional
- Mod_Gestao_Financeira.dashboard_indicadores
- Mod_Gestao_Financeira.dashboard_alertas
