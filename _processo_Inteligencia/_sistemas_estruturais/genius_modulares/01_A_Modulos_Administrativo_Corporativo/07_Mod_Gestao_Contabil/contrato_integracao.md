# Contrato De Integracao - Mod_Gestao_Contabil

## Objetivo

Definir como o modulo Mod_Gestao_Contabil se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Contabil.evento.criado
- Mod_Gestao_Contabil.evento.atualizado
- Mod_Gestao_Contabil.evento.status_alterado
- Mod_Gestao_Contabil.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Contabil/status
- GET /api/modulos/Mod_Gestao_Contabil/submodulos
- GET /api/modulos/Mod_Gestao_Contabil/registros
- POST /api/modulos/Mod_Gestao_Contabil/entrada
- POST /api/modulos/Mod_Gestao_Contabil/evento
- PATCH /api/modulos/Mod_Gestao_Contabil/status
...
- Mod_Gestao_Contabil.dashboard_operacional
- Mod_Gestao_Contabil.dashboard_indicadores
- Mod_Gestao_Contabil.dashboard_alertas
