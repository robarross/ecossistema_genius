# Contrato De Integracao - Mod_Gestao_Geointeligencia_SIG

## Objetivo

Definir como o modulo Mod_Gestao_Geointeligencia_SIG se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Geointeligencia_SIG.evento.criado
- Mod_Gestao_Geointeligencia_SIG.evento.atualizado
- Mod_Gestao_Geointeligencia_SIG.evento.status_alterado
- Mod_Gestao_Geointeligencia_SIG.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Geointeligencia_SIG/status
- GET /api/modulos/Mod_Gestao_Geointeligencia_SIG/submodulos
- GET /api/modulos/Mod_Gestao_Geointeligencia_SIG/registros
- POST /api/modulos/Mod_Gestao_Geointeligencia_SIG/entrada
- POST /api/modulos/Mod_Gestao_Geointeligencia_SIG/evento
- PATCH /api/modulos/Mod_Gestao_Geointeligencia_SIG/status
...
- Mod_Gestao_Geointeligencia_SIG.dashboard_operacional
- Mod_Gestao_Geointeligencia_SIG.dashboard_indicadores
- Mod_Gestao_Geointeligencia_SIG.dashboard_alertas
