# Contrato De Integracao - Mod_Gestao_Georreferenciamento

## Objetivo

Definir como o modulo Mod_Gestao_Georreferenciamento se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Georreferenciamento.evento.criado
- Mod_Gestao_Georreferenciamento.evento.atualizado
- Mod_Gestao_Georreferenciamento.evento.status_alterado
- Mod_Gestao_Georreferenciamento.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Georreferenciamento/status
- GET /api/modulos/Mod_Gestao_Georreferenciamento/submodulos
- GET /api/modulos/Mod_Gestao_Georreferenciamento/registros
- POST /api/modulos/Mod_Gestao_Georreferenciamento/entrada
- POST /api/modulos/Mod_Gestao_Georreferenciamento/evento
- PATCH /api/modulos/Mod_Gestao_Georreferenciamento/status
...
- Mod_Gestao_Georreferenciamento.dashboard_operacional
- Mod_Gestao_Georreferenciamento.dashboard_indicadores
- Mod_Gestao_Georreferenciamento.dashboard_alertas
