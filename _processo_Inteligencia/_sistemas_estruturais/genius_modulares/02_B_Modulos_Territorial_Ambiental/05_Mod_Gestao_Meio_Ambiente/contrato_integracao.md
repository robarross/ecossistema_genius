# Contrato De Integracao - Mod_Gestao_Meio_Ambiente

## Objetivo

Definir como o modulo Mod_Gestao_Meio_Ambiente se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Meio_Ambiente.evento.criado
- Mod_Gestao_Meio_Ambiente.evento.atualizado
- Mod_Gestao_Meio_Ambiente.evento.status_alterado
- Mod_Gestao_Meio_Ambiente.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Meio_Ambiente/status
- GET /api/modulos/Mod_Gestao_Meio_Ambiente/submodulos
- GET /api/modulos/Mod_Gestao_Meio_Ambiente/registros
- POST /api/modulos/Mod_Gestao_Meio_Ambiente/entrada
- POST /api/modulos/Mod_Gestao_Meio_Ambiente/evento
- PATCH /api/modulos/Mod_Gestao_Meio_Ambiente/status
...
- Mod_Gestao_Meio_Ambiente.dashboard_operacional
- Mod_Gestao_Meio_Ambiente.dashboard_indicadores
- Mod_Gestao_Meio_Ambiente.dashboard_alertas
