# Contrato De Integracao - Mod_Gestao_Carbono_Servicos_Ambientais

## Objetivo

Definir como o modulo Mod_Gestao_Carbono_Servicos_Ambientais se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Plataforma: 04_Plataforma_Genius_GeoAmbiental

## Eventos Publicados

- Mod_Gestao_Carbono_Servicos_Ambientais.evento.criado
- Mod_Gestao_Carbono_Servicos_Ambientais.evento.atualizado
- Mod_Gestao_Carbono_Servicos_Ambientais.evento.status_alterado
- Mod_Gestao_Carbono_Servicos_Ambientais.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Carbono_Servicos_Ambientais/status
- GET /api/modulos/Mod_Gestao_Carbono_Servicos_Ambientais/submodulos
- GET /api/modulos/Mod_Gestao_Carbono_Servicos_Ambientais/registros
- POST /api/modulos/Mod_Gestao_Carbono_Servicos_Ambientais/entrada
- POST /api/modulos/Mod_Gestao_Carbono_Servicos_Ambientais/evento
- PATCH /api/modulos/Mod_Gestao_Carbono_Servicos_Ambientais/status
...
- Mod_Gestao_Carbono_Servicos_Ambientais.dashboard_operacional
- Mod_Gestao_Carbono_Servicos_Ambientais.dashboard_indicadores
- Mod_Gestao_Carbono_Servicos_Ambientais.dashboard_alertas
