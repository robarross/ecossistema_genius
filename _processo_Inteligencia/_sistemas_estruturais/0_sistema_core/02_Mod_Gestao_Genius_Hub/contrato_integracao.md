# Contrato De Integracao - Mod_Gestao_Genius_Hub

## Objetivo

Definir como o modulo Mod_Gestao_Genius_Hub se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Genius_Hub.evento.criado
- Mod_Gestao_Genius_Hub.evento.atualizado
- Mod_Gestao_Genius_Hub.evento.status_alterado
- Mod_Gestao_Genius_Hub.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Genius_Hub/status
- GET /api/modulos/Mod_Gestao_Genius_Hub/submodulos
- GET /api/modulos/Mod_Gestao_Genius_Hub/registros
- POST /api/modulos/Mod_Gestao_Genius_Hub/entrada
- POST /api/modulos/Mod_Gestao_Genius_Hub/evento
- PATCH /api/modulos/Mod_Gestao_Genius_Hub/status
...
- Mod_Gestao_Genius_Hub.dashboard_operacional
- Mod_Gestao_Genius_Hub.dashboard_indicadores
- Mod_Gestao_Genius_Hub.dashboard_alertas
