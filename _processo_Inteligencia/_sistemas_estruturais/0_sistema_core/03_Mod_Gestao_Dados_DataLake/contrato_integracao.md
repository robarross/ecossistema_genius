# Contrato De Integracao - Mod_Gestao_Dados_DataLake

## Objetivo

Definir como o modulo Mod_Gestao_Dados_DataLake se conecta ao ecossistema Genius de forma plug and play, preservando independencia operacional e integracao com plataformas, dados, APIs, dashboards e seguranca.
...
- Mod_Gestao_Dados_DataLake.evento.criado
- Mod_Gestao_Dados_DataLake.evento.atualizado
- Mod_Gestao_Dados_DataLake.evento.status_alterado
- Mod_Gestao_Dados_DataLake.evento.finalizado
...
- GET /api/modulos/Mod_Gestao_Dados_DataLake/status
- GET /api/modulos/Mod_Gestao_Dados_DataLake/submodulos
- GET /api/modulos/Mod_Gestao_Dados_DataLake/registros
- POST /api/modulos/Mod_Gestao_Dados_DataLake/entrada
- POST /api/modulos/Mod_Gestao_Dados_DataLake/evento
- PATCH /api/modulos/Mod_Gestao_Dados_DataLake/status
...
- Mod_Gestao_Dados_DataLake.dashboard_operacional
- Mod_Gestao_Dados_DataLake.dashboard_indicadores
- Mod_Gestao_Dados_DataLake.dashboard_alertas
